...
// MONGODB_URI dipakai bila tersedia (mis. dari layanan hosting); jika tidak,
// fallback ke konfigurasi DB_HOST/DB_NAME.
...
if (MONGODB_URI) {
	...
	if (!DB_HOST || !DB_NAME) {
		console.error(
			"Error: MONGODB_URI or (DB_HOST and DB_NAME) environment variables are required",
		);
		process.exit(1);
	}
