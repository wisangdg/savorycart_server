...
class TokenService {
	...
	async refreshAccessToken(refreshToken) {
		...
		// Cek ulang: pastikan refresh token belum dicabut selama pencarian user
		// (misalnya logout bersamaan) sebelum menerbitkan access token baru.
		const stillValid = await this.verifyRefreshToken(refreshToken);
